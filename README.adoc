...
Si vous ne pouvez pas synchroniser votre dépôt avec GitPod, essayez une des solutions suivantes :

- Essayez d'autoriser GitPod à accéder à votre dépôt :
. Allez sur https://gitpod.io/integrations 
. Sélectionnez btn:[Manage on github.com]
+
image::images/config.png[]
+
. 
- Mettez votre dépôt public en :
. allant sur l'onglet menu:Settings[Danger Zone] de votre dépôt GitHub
. cliquant sur btn:[Change visibility] :
+
